...
" Autosave file everytime you hit enter in normal mode.
nmap <cr> :write<cr>
...
func! CompileRunJava()
  exec "w"
  if &filetype == 'java'
    exec "!javac -d out % && java -cp %:p:h/out %:t:r"
  endif
endfunc
" }}}
...
autocmd Filetype markdown setlocal colorcolumn=0 wrap linebreak nolist textwidth=0 wrapmargin=0 " http://vim.wikia.com/wiki/Word_wrap_without_line_breaks
...
autocmd BufNewFile  *.java   0r ~/.vim/templates/class.java
" }}}
